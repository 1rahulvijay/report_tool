                        ...
                        rx.vstack(
                                ...
                                rx.hstack(
                                                ...
                                                rx.vstack(
                                                    rx.radix.select.root(
                                                        ...
                                                        rx.radix.select.content(
                                                            _inline_search(
                                                                "Search tables...",
                                                                AppState.join_table_search,
                                                                AppState.set_join_table_search,
                                                            ),
                                                            rx.radix.select.group(
                                                                rx.foreach(
                                                                    AppState.join_anchor_display,
                                                                    lambda pair: (
                                    ...
                                    rx.vstack(
                                        ...
                                        rx.hstack(
                                            ...
                                            _join_type_item(
                                                "left", "Left", "arrow-left-from-line"
                                            ),
                                            _join_type_item(
                                                "right",
                                                "Right",
                                                ...
                                                rx.box(
                                                    rx.radix.select.root(
                                                        ...
                                                        rx.radix.select.content(
                                                            ...
                                                            rx.radix.select.group(
                                                                rx.foreach(
                                                                    AppState.filtered_join_datasets_display,
                                                                    lambda pair: (
                                                                        rx.radix.select.item(
                                                                            pair[1],
                                                                            value=pair[
                            ...
                            rx.box(
                                rx.vstack(
                                    ...
                                    # rows
                                    rx.foreach(
                                        AppState.new_join_conditions,
                                        _render_join_condition_row,
                                    ),
                                    width="100%",
                                    spacing="0",
                            ...
                            width="100%",
                            class_name="flex-1 p-4 overflow-y-auto overflow-x-hidden custom-scrollbar",
                        ),
                        # Footer
                        rx.vstack(
                            # Summary bar
                            rx.hstack(
                                rx.hstack(
                                    rx.icon(
                                        tag="eye", size=14, class_name="text-accent"
                                    ),
                                    rx.text(
                                        "Resulting Dataset: ",
                                        rx.text(
...
def _render_join_condition_row(condition: dict, index: int) -> rx.Component:
    ...
    return rx.grid(
        # Left Column Select — with inline search
        rx.box(
            rx.radix.select.root(
                rx.radix.select.trigger(
                ...
                rx.radix.select.content(
                    _inline_search(
                        "Search columns...",
                        AppState.join_left_col_search,
                        AppState.set_join_left_col_search,
                    ),
                    rx.radix.select.group(
                        rx.foreach(
                            AppState.filtered_left_col_display,
                            lambda pair: rx.radix.select.item(pair[1], value=pair[0]),
                        )
                    ),
                    position="popper",
                ),
        ...
        # Right Column Select — with inline search
        rx.box(
            rx.radix.select.root(
                rx.radix.select.trigger(
                ...
                rx.radix.select.content(
                    _inline_search(
                        "Search columns...",
                        AppState.join_right_col_search,
                        AppState.set_join_right_col_search,
                    ),
                    rx.radix.select.group(
                        rx.foreach(
                            AppState.filtered_right_col_display,
                            lambda pair: rx.radix.select.item(pair[1], value=pair[0]),
                        )
                    ),
                    position="popper",
